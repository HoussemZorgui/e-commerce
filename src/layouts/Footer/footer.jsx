                        ...
                        <div className="row">
                            <div className="col-md-3 col-xs-6">
                                <div className="footer">
                                    ...
                                    <p>PhoneStore | Votre Site De Vente en Ligne </p>
                                    <ul className="footer-links">
                                        <li><a href="#"><i className="fa fa-map-marker" />Cite les jardins</a></li>
                                        <li><a href="#"><i className="fa fa-phone" />+216 90767743</a></li>
                                        <li><a href="#"><i className="fa fa-envelope-o" />houssemzorgui10@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-md-3 col-xs-6">
